...
def test():
    StraightPID_left(0, 12, 40, slow_stop=0)
    wait_for_seconds(0.5)
    StraightPID_double(0, -4, 30)
    wait_for_seconds(0.5)
    for i in range(3):
        StraightPID_left(0, 5, 50, slow_stop=0)
        wait_for_seconds(0.5)
        StraightPID_double(0, -4, 30, slow_stop=0)
        wait_for_seconds(0.5)
