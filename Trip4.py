...
def StraightPID_abs(degree_abs, dist, speed, slow_stop=1, Kp=0.4, Ki=0.005, Kd=0.8):
   '''
   mvoe straight following specific absolute gyro degree. It use speed to adjust direction
...
def trip_4():
   StraightPID_abs(0, 55, 40)
   TurningPID_abs(40)
   StraightPID_abs(40, 50, 50)
   StraightPID_abs(40, 7, -50)
   TurningPID_abs(75)
   StraightPID_abs(75, 30, 40)
   Run2line()
   TurningPID_abs(15)
   StraightPID_abs(15, 5, 30)
   StraightPID_abs(20, 15, 40)
   LeftArm.run_for_rotations(1, -100)
   StraightPID_abs(-5, 30, 40)
   LeftArm.run_for_rotations(1, 100)
   TurningPID_abs(-90)
   StraightPID_abs(-90, 50, 40)
