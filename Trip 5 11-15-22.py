...
def trip_5():
    ...
    TurningPID_abs(hitangle)
    StraightPID_abs(hitangle, 33, 40, Kp=0.8, Kd=5)
    wait_for_seconds(0.5)

    StraightPID_abs(hitangle, -4, 40)
    wait_for_seconds(0.5)
    StraightPID_abs(hitangle, 5, 40, Kp=0.8, Kd=5)
    wait_for_seconds(0.5)
    StraightPID_abs(hitangle, -4, 40)
    wait_for_seconds(0.5)
    StraightPID_abs(hitangle, 5, 40, Kp=0.8, Kd=5)
    wait_for_seconds(0.5)
    StraightPID_abs(hitangle, -15, 40)
    StraightPID_abs(40, -70, 50) """
