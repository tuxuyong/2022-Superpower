...
def done():
    '''
    Trip done, waiting for next trip
    '''
    hub.light_matrix.show_image('HAPPY')
...
def trip_4():
    ...
    StraightPID_right(45, -8, 40)
    # Hand
    Turn(90)
    
    StraightPID_right(90, 40, 60)
    StraightPID_right(90, -10, 40)
    ...
    Turn(32)
    StraightPID_right(32, 36, 40)
    Turn(0)
    StraightPID_right(0, -8, 40)
    wait_for_seconds(0.5)
    RightArm.run_for_rotations(1, -100)
    wait_for_seconds(0.5)
    StraightPID_right(-2, 27, 40)
    RightArm.run_for_rotations(1, 100)
    StraightPID_right(-10, -3, 30)
    TurningPID_abs(-60)
    StraightPID_right(-60, 80, 70) 
